...
typedef enum {
	...
	MPPA_RPC_ODP_CLASS_VG,
	MPPA_RPC_ODP_N_CLASS,
	MPPA_RPC_ODP_MAX_CLASS = 32
...
typedef int (*mppa_rpc_odp_print_t)(const struct mppa_rpc_odp *msg, const uint8_t *payload);
typedef int (*mppa_rpc_odp_handler_t)(unsigned remoteClus, mppa_rpc_odp_t *msg, uint8_t *payload);

/** RPC client status */
extern int g_rpc_init;

/* Include all modules available */
#if __has_include(<odp/rpc/eth.h>)
#  include <odp/rpc/eth.h>
#endif
#if __has_include(<odp/rpc/pcie.h>)
#  include <odp/rpc/pcie.h>
#endif
#if __has_include(<odp/rpc/c2c.h>)
#  include <odp/rpc/c2c.h>
#endif
#if __has_include(<odp/rpc/rnd.h>)
#  include <odp/rpc/rnd.h>
#endif
#if __has_include(<odp/rpc/fp.h>)
#  include <odp/rpc/fp.h>
#endif
#if __has_include(<odp/rpc/vg.h>)
#  include <odp/rpc/vg.h>
#endif
