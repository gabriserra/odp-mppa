...
static int loopback_recv(pktio_entry_t *const pktio_entry,
			 int index ODP_UNUSED,
			 odp_packet_t pkts[], unsigned len)
{
	int nbr, i;
...
static int loopback_send(pktio_entry_t * const pktio_entry,
			 int index ODP_UNUSED,
