...
_DEBUG_CONF_FLAGS := --enable-debug-print --enable-debug --enable-helper-debug-print
ifdef VERBOSE
DEBUG_CONF_FLAGS := --enable-debug-print --enable-helper-debug-print
endif
ifdef DEBUG
...
RPCINCLUDES := $(shell find $(RPCFIRMWARE_PATH)/include/odp -name *.h)
